...
class ResetPasswordController extends AbstractController
{
    ...
    if ($request->get('email')) {
        ...
        if ($user){
            ...
            $content = "Bonjour ".$user->getPrenom()."<br/> Vous avez demandé à réinitialiser votre mot de passe sur le site Investir en Afrique.<br/><br/>";
            $content .= "Merci de bien vouloir cliquer sur le lien suivant pour <a href='".$url."'> mettre à jour votre mot de passe</a>.";
        
            $mailjet = new Mailjet();
            $mailjet ->send($user->getEmail(), $user->getPrenom().''.$user->getNom(), 'Réinitialiser votre mot de passe sur Investir en Afrique', $content);
        
            $this->addFlash('notice', 'Vous allez recevoir dans quelques secondes un mail de réinitialisation');
        } else {
